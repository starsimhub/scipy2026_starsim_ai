...
# agent evaluations
inspect eval eval/agent/starsim.py --model sonnet -T with_plugin=False -T tutorial=starsim_t1
inspect eval eval/agent/starsim.py --model sonnet -T with_plugin=True -T tutorial=starsim_t1
